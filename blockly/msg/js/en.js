...
Blockly.Msg.DHT_TOOLTIP = 'DHT11 digital temperature & humidity sensor module ';
Blockly.Msg.DHT_HELPURL = 'https://lastminuteengineers.com/dht11-module-arduino-tutorial';

Blockly.Msg.DS18B20_TOOLTIP = 'DS18B20 is 1-Wire interface Temperature sensor manufactured by Dallas Semiconductor Corp. The unique 1-Wire® Interface requires only one digital pin for two way communication with a microcontroller.'
Blockly.Msg.DS18B20_HELPURL = 'https://lastminuteengineers.com/ds18b20-arduino-tutorial'

Blockly.Msg.PMS_TOOLTIP = 'The Plantower PMS5003 is a low cost laser particle counter, one of a range of sensors by Plantower that also include the PMS1003, PMS3003, and PMS7003.'
Blockly.Msg.PMS_HELPURL = 'https://github.com/teusH/MySense/blob/master/docs/pms7003.md'

Blockly.Msg.BME280_TOOLTIP = 'At the heart of the module is the next-generation digital temperature, humidity and pressure sensor manufactured by Bosch'
Blockly.Msg.BME280_HELPURL = 'https://lastminuteengineers.com/bme280-arduino-tutorial'

Blockly.Msg.H1750_TOOLTIP = 'BH1750 is a digital ambient light sensor that is used commonly used in mobile phones to manipulate the screen brightness based on the environment lighting. This sensor can accurately measure the LUX value of light up to 65535lx.'
Blockly.Msg.H1750_HELPURL = 'https://components101.com/sensors/bh1750-ambient-light-sensor'

Blockly.Msg.interrupts_TOOLTIP = 'Interrupts are useful for making things happen automatically in microcontroller programs and can help solve timing problems. Good tasks for using an interrupt may include reading a rotary encoder, or monitoring user input.'
Blockly.Msg.interrupts_HELPURL = 'https://www.arduino.cc/reference/en/language/functions/external-interrupts/attachinterrupt'

Blockly.Msg.RFID_TOOLTIP = 'RFID or Radio Frequency Identification system consists of two main components, a transponder/tag attached to an object to be identified, and a Transceiver also known as interrogator/Reader.'
Blockly.Msg.RFID_HELPURL = 'https://lastminuteengineers.com/how-rfid-works-rc522-arduino-tutorial/'

Blockly.Msg.Ultrasonic_TOOLTIP = 'At its core, the HC-SR04 Ultrasonic distance sensor consists of two ultrasonic transducers. The one acts as a transmitter which converts electrical signal into 40 KHz ultrasonic sound pulses. The receiver listens for the transmitted pulses. If it receives them it produces an output pulse whose width can be used to determine the distance the pulse travelled.'
Blockly.Msg.Ultrasonic_HELPURL = 'https://lastminuteengineers.com/arduino-sr04-ultrasonic-sensor-tutorial/'

Blockly.Msg.IR_TOOLTIP = 'A typical infrared communication system requires an IR transmitter and an IR receiver. The transmitter looks just like a standard LED, except it produces light in the IR spectrum instead of the visible spectrum. If you have a look at the front of a TV remote, you’ll see the IR transmitter LED.'
Blockly.Msg.IR_HELPURL = 'https://www.circuitbasics.com/arduino-ir-remote-receiver-tutorial/'

Blockly.Msg.LCD_TOOLTIP ='A typical I2C LCD display consists of a HD44780 based character LCD display and an I2C LCD adapter. Let’s get to know them one by one.'
Blockly.Msg.LCD_HELPURL='https://lastminuteengineers.com/i2c-lcd-arduino-tutorial'

Blockly.Msg.PZEM004T_TOOLTIP = 'Electrical (AC) parameter measurement function such as voltage, current, connected load and total consuption.'
Blockly.Msg.PZEM004T_HELPURL = 'https://innovatorsguru.com/ac-digital-multifunction-meter-using-pzem-004t'

Blockly.Msg.PZEM017_TOOLTIP = 'Electrical (DC) parameter measurement function such as voltage, current, connected load and total consuption.'
Blockly.Msg.PZEM017_HELPURL = 'https://peacefair.en.made-in-china.com/product/IsCEdZMJMhki/China-Pzem-017-0-300V-DC-Voltage-Current-Power-Energy-Meter-Modbus-with-200A-Shunt.html'

Blockly.Msg.MLX90614_TOOLTIP ='The MLX90614 Temperature sensor is manufactured by a company called Melexis. The sensor is factory calibrated and hence it acts like a plug and play sensor module for speeding up development processes.'
Blockly.Msg.MLX90614_HELPURL = 'https://components101.com/sensors/melexis-mlx90614-contact-less-ir-temperature-sensor'

Blockly.Msg.QMC5883_TOOLTIP = 'QMC5883 are called digital compass'
Blockly.Msg.QMC5883_HELPURL = 'https://surtrtech.com/2018/02/01/interfacing-hmc8553l-qmc5883-digital-compass-with-arduino/'

Blockly.Msg.Bluetooth_TOOLTIP = 'Bluetooth is a very cool module which can add two-way (full-duplex) wireless functionality to your projects. You can use this module to communicate between two microcontrollers like Arduino or communicate with any device with Bluetooth functionality like a Phone or Laptop.'
Blockly.Msg.Bluetooth_HELPURL = 'https://components101.com/wireless/hc-05-bluetooth-module'
...
Blockly.Msg.OLED_IconName = "OLED Icon design";
...
Blockly.Msg.ST7735_init = "TFT ST7735";
Blockly.Msg.ST7735_init2 = "SCL=SCK SDA=MOSI.";
Blockly.Msg.ST7735_PIN_CS = "CS";
Blockly.Msg.ST7735_PIN_RST = "RST/RES";
Blockly.Msg.ST7735_PIN_DC = "A0/DC";
Blockly.Msg.ST7735_WRAP = "color";
Blockly.Msg.ST7735_FILLBACKGROUND = "Fill backgroundColor";
Blockly.Msg.ST7735_Rotate = "rotate";
...
Blockly.Msg.ST7735_TEXTCOLOR2 = "color";
...
Blockly.Msg.ST7735_Drawroundrectangleradius = "round";
...
Blockly.Msg.ST7735_IconName = "Icon";
Blockly.Msg.ST7735_ValueList = "Hex array";
Blockly.Msg.ST7735_DrawiconName = "Draw Icon";
Blockly.Msg.yes = "Yes";
Blockly.Msg.no = "No";
Blockly.Msg.LCD_SHIELD_PRINT_TEXT = "show";
Blockly.Msg.LCD_SHIELD_PRINT_TEXT_tooltip = "display the text in the specified location";

Blockly.Msg.OTTO9_GETG_TEXT = "Read Accelerations & Angular Velocity";
Blockly.Msg.OTTO9_GETG_TEXT2 = "Value";

Blockly.Msg.RTCDS3231_NAME="DS3231 init";
Blockly.Msg.RTCDS3231_RTC="DS3231 Set Date & Time ";
...
Blockly.Msg.RTCDS3231_READ_RTC="DS3231 Read Date & Time";
Blockly.Msg.RTCDS3231_VALUES="value";
Blockly.Msg.RTCDS3231_Name2="DS3231 ";
Blockly.Msg.RTCDS3231_TEXT_DOFWEEK="Day of week in string";
Blockly.Msg.RTCDS3231_TEXT_MONTH="Month in string ";

Blockly.Msg.RTCDS1302_NAME="DS1302 init";
Blockly.Msg.RTCDS1302_RTC="DS1302 Set Date & Time ";
...
Blockly.Msg.RTCDS1302_READ_RTC="DS1302 Read Date & Time";
Blockly.Msg.RTCDS1302_VALUES="value";
Blockly.Msg.RTCDS1302_Name2="DS1302 ";
Blockly.Msg.RTCDS1302_Name2="DS1302 ";
...
Blockly.Msg.bluetooth2_tooltip = "sends data via bluetooth \nconnecting module HC-06 to Pins 0 and 1 \net cross Pins Rx & Tx";
Blockly.Msg.bluetooth_init_tooltip = "";
Blockly.Msg.bluetooth_helpurl = "https://www.ottodiy.com/academy"; // do not translate
...
Blockly.Msg.SSERIAL_BT_TX="TX";
Blockly.Msg.SSERIAL_BT_RX="RX";
